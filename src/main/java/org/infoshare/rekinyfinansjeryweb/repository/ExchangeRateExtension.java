...
public interface ExchangeRateExtension {
    ...
    List<ExchangeRateCurrency> findSelectedDates(FiltrationSettingsDTO filtrationSettings, List<LocalDate> dates);
    List<ExchangeRateCurrency> findSelectedDates(SearchSettingsDTO searchSettings, List<LocalDate> dates);
}
